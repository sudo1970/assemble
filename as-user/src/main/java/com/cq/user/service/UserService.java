...
//        AccountManager accountManager = userMapper.selectByPhone(phone);
//        AssertUtil.isTrue(accountManager == null, "该手机号未注册");
//        AssertUtil.isTrue(accountManager.getIsValid() == 0, "该用户已锁定，请先解锁");
//    }
    /**
     * 登录
